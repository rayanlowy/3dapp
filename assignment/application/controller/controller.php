...
class Controller {
	...
	// Load the home page method — this method is loaded by default — http://localhost/3dapp/assignment/index.php/
	...
	// http://localhost/3dapp/assignment/index.php/apidrinksimages
